...
export default function Approver_address_input({ handleEnterFocus, onApproverChange, disabled = false, initialData }) {
  ...
  useEffect(() => {
    if (onApproverChange) onApproverChange(selected);
  }, [selected, onApproverChange]);
