...
<body class=" flex flex-row ">
    <div class="flex w-[10%] h-full">
        <div class=" pr-4 text-center b text-xs ">
            ...
            <p class="ml-2">
              जिल्ला __________ गा.वि.स/गा.पा/न. पा. ___________ वडा नं. _________ मा बस्ने वर्ष _____ को
                ________________
            </p>
            <p>
              जिल्ला ___________ गा.वि.स/गा.पा/न. पा. ___________ वडा नं. ___________ मा बस्ने वर्ष _____ को
                _______________
            </p>
    ...
    <div class="px-3 text-justify">
        ...
        <h4 class="indent-5 text-xs">
            ...
            ${convert(f.address.permanent.wada || "1", "toNp")} स्थायी ठेगाना भई बसोबास गर्ने वर्ष ${convert(f.age || "", "toNp")} को ${f.applicant_name || ""} को नाउँमा ${f.applicantType || "-"} अन्तर्गत जम्मा
            ...
            हकभोगमा रहेको तपसिलमा उल्लेख भए मोजिमको जायजेथा सुरक्षण वापत संस्थालाई धितो लेखि दिएमा धितो जमानी दातासंग
            ...
            लागने ब्याज तथा जरिवाना समेत नतिरे/ बुझाएमा सहकारी ऐन तथा संस्थाको नियमावली अनुसार तपसिलमा उल्लेखित धितोदाता ${ownerNamesString || ""} को नाउँ
