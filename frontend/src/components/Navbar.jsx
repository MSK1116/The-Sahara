      ...
      <nav className=" sticky top-0 z-50 bg-gray-50 shadow-md px-10 py-4 rounded-b-xl">
        <div className=" flex flex-row justify-between items-center">
          ...
          <div className=" flex flex-row gap-x-11 items-center justify-center">
            ...
            <Link href={"/auth/logout"} className=" gap-x-3 items-center justify-center text-white flex flex-row from-blue-600 to-blue-700 bg-linear-to-br mx-auto rounded-md px-2 py-2">
              <div> Logout </div>
