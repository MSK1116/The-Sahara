    ...
    <>
      <nav className=" sticky top-0 z-50 bg-gray-50 shadow-md px-10 py-4 rounded-b-xl">
        <div className=" flex flex-row justify-between items-center">
          <Link href={"/"} alt="home page" className=" active:scale-95 transition-all duration-300 relative w-60 h-15">
          ...
          <div className="  flex flex-row gap-x-11 items-center justify-center">
            <Link className=" active:scale-95  transition-all duration-300" href={"/"}>
              <TiHome className=" size-7.5 fill-blue-600 " />
            </Link>
            <Button
              type="button"
              onClick={() => router.push("/auth/logout")}
              className=" gap-x-3 items-center cursor-pointer active:scale-95 transition-all duration-300 justify-center text-white flex flex-row from-blue-600 to-blue-700 bg-linear-to-br mx-auto rounded-md px-2 py-2">
              <div> Logout </div>
